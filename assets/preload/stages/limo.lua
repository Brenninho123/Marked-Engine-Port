...
makeLuaSprite("overlay", "shaders/sunlight", -1700, -1550)
...
function onCreate()
	setPropertyFromClass('PauseSubState', 'songName', 'pausemusic/week4pause')
	playSound("intromusic/week4pause", 0.7, 'lol')
